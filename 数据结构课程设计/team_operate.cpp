...
void buildBST(BST& bst) {//从文件中读取参赛队伍信息并构建二叉排序树
    ...
    Team ss[100];
        ...
        while (category != "quit") {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                start.pop();
                cout << "队伍编号: " << t.id << endl;
                cout << "作品名称: " << t.work_name << endl;
                cout << "参赛类别: " << t.match_sort << endl;
                cout << "参赛者: " << t.player << endl;
                cout << "指导教师: " << t.teacher << endl;
                cout << endl;
            }
            for (int i = 0; i < result.size(); i++) {
                Sleep(1000);
                cout << "---------------------------------------------------------------------" << endl;
                cout << "正在进行比赛的队伍" << endl;
                cout << "队伍编号: " << ss[i].id << endl;
                cout << "作品名称: " << ss[i].work_name << endl;
                cout << "参赛类别: " << ss[i].match_sort << endl;
                cout << "参赛者: " << ss[i].player << endl;
                cout << "指导教师: " << ss[i].teacher << endl;
                cout << "---------------------------------------------------------------------" << endl;
                cout << endl;
            }
        }
...
int main() {
    string choice;
    cout << "请输入想要实现的功能(1:参赛队伍管理 2:按赛事类别查找队伍 3:叫号 4.导航系统(quit退出)):";
    cin >> choice;
    while (1) {
        if (choice == "1") {
            operate();
